...
requestAnimationFrame(function anim(t) {
    ...
    ctx.fillStyle = "#000"; // qora fon
    drawCircle(0, 0, w * 10); // katta aylana fon
    ctx.fillStyle = ctx.strokeStyle = "#fff"; // oq rangli chiziq
    t /= 1000;
...
function noise(x, y, t = 101) {
    let w0 = Math.sin(0.3 * x * 1.4 + t * 2.0 +
             2.5 * Math.sin(0.4 * y + 1.3 * t + 1.0));
             
    let w1 = Math.sin(0.2 * y + 1.5 * t + 2.8 +
             2.3 * Math.sin(0.5 * x - 1.2 * t - 1.3));
